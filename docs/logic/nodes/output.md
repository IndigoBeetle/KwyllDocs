...
![Output Node](../../assets/nodes/output.png){align=left width="25%"} The
*Output Node* represents an output value from a [Sub
Graph](../../introduction/logic/logic.md#shared-logic). The provided name is
used on the sub graph node as the name for the output port.
...
information regarding the use of sub graphs.
